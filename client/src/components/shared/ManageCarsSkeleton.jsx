        ...
        {[...Array(3)].map((_, i) => (
          <tr key={i} className="border-t border-borderColor">
            <td className="flex items-center gap-2 p-3">
              <div className="md:w-12 md:h-12 w-8 h-8 bg-gray-200 rounded-md" />
              <div className="space-y-1 max-md:hidden">
                <div className="w-24 h-4 bg-gray-200 rounded" />
                <div className="w-20 h-3 bg-gray-200 rounded" />
              </div>
            </td>
            <td className="p-1 md:p-3 font-medium max-md:hidden">
              <div className="w-20 h-4 bg-gray-200 rounded" />
            </td>
            <td className="p-1 md:p-3 font-medium">
              <div className="w-12 h-4 bg-gray-200 rounded" />
            </td>
            <td className="p-1 md:p-3 font-medium">
              <div className="w-15 h-6 bg-gray-200 rounded-full" />
            </td>
