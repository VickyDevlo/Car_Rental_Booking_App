...
const HeroSection = () => {
  ...
  const disabled = !pickupLocation || !pickupDate;
  ...
  return (
    ...
    >
      ...
      justify-between p-2.5 rounded-lg md:rounded-full max-w-80 md:max-w-[850px] w-full bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]"
      >
        <div className="flex flex-col md:flex-row items-center max-md:gap-7 gap-10 min-md:ml-8 w-full">
          <div className="flex flex-col items-start max-sm:items-center max-sm:w-full gap-2 md:border-r border-gray-300 px-2">
            ...
            max-md:border-b border-borderColor"
            >
          ...
          <div className="flex flex-col items-start max-sm:items-center max-sm:w-full gap-2 md:border-r border-gray-300 md:px-2">
            ...
            <input
              ...
              className="text-sm text-gray-800 focus:outline py-1 max-md:border-b border-borderColor"
              required
            />
          </div>
          ...
          <div className="flex flex-col items-start max-sm:items-center max-sm:w-full gap-2 md:border-r border-gray-300 md:px-2">
            ...
            <input
              ...
              disabled={disabled}
              className="text-sm text-gray-800 bg-white focus:outline-none py-1 max-md:border-b border-borderColor"
              required
            />
          </div>
        </div>
        <button
          ...
          className=" flex items-center justify-center gap-1 text-white
            px-9 py-3 max-md:mt-4 max-md:w-full bg-primary hover:bg-primary-dull 
